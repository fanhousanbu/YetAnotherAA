export default () => ({
  ...
  p2p: {
    bootstrapNodes: process.env.P2P_BOOTSTRAP_NODES 
      ...
      : ['ws://localhost:8001', 'ws://localhost:8002'],
    heartbeatInterval: parseInt(process.env.P2P_HEARTBEAT_INTERVAL || '30000', 10),
    discoveryInterval: parseInt(process.env.P2P_DISCOVERY_INTERVAL || '60000', 10),
  },
});