                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-1 text-sm text-blue-700">
                        <p>Click the button below to authenticate using your device's passkey (Face ID, Touch ID, Windows Hello, etc.).</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-1 text-sm text-yellow-700">
                        <p>This will register a new passkey specifically for this device. You'll need your existing credentials to verify your identity.</p>
                      </div>
                    </div>
                  </div>
                </div>
