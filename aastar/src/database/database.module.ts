...
import { User, Account, Transfer, Passkey, BlsConfig, UserToken, Guardian, RecoveryRequest } from "../entities";
  ...
  static forRoot(): DynamicModule {
    ...
    if (dbType === "postgres") {
      imports.push(
        TypeOrmModule.forRootAsync({
          ...
          useFactory: async (configService: ConfigService) => {
            ...
            return {
              type: "postgres",
              url: databaseUrl,
              entities: [User, Account, Transfer, Passkey, BlsConfig, UserToken, Guardian, RecoveryRequest],
        ...
        TypeOrmModule.forFeature([User, Account, Transfer, Passkey, BlsConfig, UserToken, Guardian, RecoveryRequest])
      );
