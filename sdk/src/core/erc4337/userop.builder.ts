...
export class UserOpBuilder {
    ...
    async buildUserOp(params: {
        ...
        return {
            ...
            verificationGasLimit: params.verificationGasLimit || UserOpBuilder.DEFAULT_VERIFICATION_GAS_LIMIT,
            ...
            maxPriorityFeePerGas: params.maxPriorityFeePerGas || UserOpBuilder.DEFAULT_MAX_PRIORITY_FEE_PER_GAS,
