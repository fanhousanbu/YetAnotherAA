...
describe('PaymasterManager', () => {
  ...
  describe('removeCustomPaymaster', () => {
    it('should remove an existing paymaster', async () => {
      await pm.addCustomPaymaster('user-1', 'to-delete', '0x1234567890123456789012345678901234567890');
  ...
  describe('getPaymasterData', () => {
    ...
    it('should throw for unknown paymaster name', async () => {
      await expect(
        pm.getPaymasterData('user-1', 'unknown-pm', {}, '0x1234'),
      ).rejects.toThrow('Paymaster unknown-pm not found');
    });
