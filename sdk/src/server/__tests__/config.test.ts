...
describe('validateConfig', () => {
  ...
  it('should throw if rpcUrl is missing', () => {
    expect(() => validateConfig(makeValidConfig({ rpcUrl: '' }))).toThrow(
      'rpcUrl is required',
    );
  });
  ...
  it('should throw if chainId is missing', () => {
    expect(() => validateConfig(makeValidConfig({ chainId: 0 }))).toThrow(
      'chainId is required',
    );
  });
  ...
  it('should throw if storage is missing', () => {
    expect(() =>
      validateConfig(makeValidConfig({ storage: undefined as any })),
    ).toThrow('storage adapter is required');
  });

  it('should throw if signer is missing', () => {
    expect(() =>
      validateConfig(makeValidConfig({ signer: undefined as any })),
    ).toThrow('signer adapter is required');
  });
