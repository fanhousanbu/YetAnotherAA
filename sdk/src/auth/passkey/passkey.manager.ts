...
export class PasskeyManager {
     ...
     */
    async register(params: PasskeyRegistrationParams): Promise<{ user: any, token: string, passkey: PasskeyInfo }> {
        ...
        const completeResponse = await this.api.post(
