...
# Generate signatures for 3 participants from 5 total keys
node index.js --message "UserOp transaction hash" --m 5 --n 3
```
...
### Testnet Deployments
- **Sepolia**: `0xa82e99929032dC248d2AE77FA9E6FE4124AEBc00` (Previous version)
- **Mainnet**: TBD
...
- **Issues**: [GitHub Issues](https://github.com/your-org/AAStarValidator/issues)
- **Discussions**: [GitHub Discussions](https://github.com/your-org/AAStarValidator/discussions)  
- **Documentation**: [Project Wiki](https://github.com/your-org/AAStarValidator/wiki)
